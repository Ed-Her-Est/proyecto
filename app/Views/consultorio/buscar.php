...
<head>
    ...
    <title>Formulario de Consultorio</title>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            <h2 class="form-title">Buscar Consultorio</h2>
            <form action="<?= base_url('index.php/consultorio/buscar/'); ?>" method="GET">
                <label for="numeroConsultorio">Número de Consultorio</label>
                <input type="text" class="form-control" name="numeroConsultorio">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Tabla de consultorios con clases de Bootstrap -->
            <table class="table table-bordered table-striped text-center">
                ...
                <tbody>
                    <?php foreach ($consultorios as $consultorio) : ?>
                        <tr>
                            <td><?= $consultorio['numeroConsultorio'] ?></td>
                            <td><?= $consultorio['estatus'] ?></td>
                            <td>
                                <!-- Enlace para editar con botón de Bootstrap -->
                                <a href="<?= base_url('consultorio/editar/' . $consultorio['ID_Consultorio']) ?>" class="btn btn-primary btn-sm">Editar</a>

                                <!-- Formulario para eliminar con botón de Bootstrap -->
                                <form action="<?= base_url('consultorio/eliminar/' . $consultorio['ID_Consultorio']) ?>" method="POST" style="display:inline;">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este consultorio?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach ?>
