...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            <h2 class="form-title">Agregar Consultorio</h2>
            <form action="<?= base_url('index.php/consultorio/insert'); ?>" method="POST">
                <?= csrf_field() ?>
                <div class="container">
                <div class="container"><div class="mb-3">
    <label for="numeroConsultorio" class="form-label">Número de Consultorio (1-5)</label>
    <input type="text" class="form-control" name="numeroConsultorio" id="numeroConsultorio" required pattern="[1-5]">
