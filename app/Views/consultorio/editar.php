    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Editar Consultorio</h2>
                <div class="row justify-content-center result-container">
                    <table class="table">
                        <tr>
                            <th>Resultado de Consultorio</th>
                        </tr>
                        <tr>
                            <td><pre><?php print_r($consultorio); ?></pre></td>
                        </tr>
                    </table>
                </div>
                <form action="<?= base_url('/consultorio/update'); ?>" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="estatus" id="estatus" value="<?= $consultorio['estatus'] ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="numeroConsultorio">Número de Consultorio (1-5)</label>
                        <input type="text" class="form-control" name="numeroConsultorio" id="numeroConsultorio" value="<?= $consultorio['numeroConsultorio'] ?>" required pattern="[1-5]">
                        <small>Solo se permiten números del 1 al 5.</small>
                    </div>
