...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            ...
            <form action="<?= base_url('index.php/paciente/buscar/'); ?>" method="GET">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Tabla de pacientes con clases de Bootstrap -->
                    ...
                    <?php foreach ($pacientes as $paciente) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('paciente/editar/' . $paciente['ID_Paciente']) ?>" class="btn btn-primary btn-sm">Editar</a>

                                <!-- Formulario para eliminar con botón de Bootstrap -->
                                <form action="<?= base_url('paciente/eliminar/' . $paciente['ID_Paciente']) ?>" method="POST" style="display:inline;">
