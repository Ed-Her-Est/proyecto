    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Editar Signos Vitales</h2>
                <div class="row justify-content-center result-container">
                    <table class="table">
                        ...
                        <tr>
                            <td><pre><?php print_r($signosVitales); ?></pre></td>
                        </tr>
                    </table>
                </div>
                <form action="<?= base_url('/signosvitales/update'); ?>" method="POST">
                    <?= csrf_field() ?>
                    <input type="hidden" name="id" value="<?= $signosVitales['ID_SignosVitales'] ?>" />
                    <div class="mb-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="presionArterial" id="presionArterial" value="<?= $signosVitales['presionArterial'] ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="frecuenciaCardiaca">Frecuencia Cardiaca (FC)</label>
                        <input type="number" class="form-control" name="frecuenciaCardiaca" id="frecuenciaCardiaca" value="<?= $signosVitales['frecuenciaCardiaca'] ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="tensionArterial">Tensión Arterial (TA)</label>
                        <input type="text" class="form-control" name="tensionArterial" id="tensionArterial" value="<?= $signosVitales['tensionArterial'] ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="saturacionOxigeno">Saturación de Oxígeno (SpO2)</label>
                        <input type="number" class="form-control" name="saturacionOxigeno" id="saturacionOxigeno" value="<?= $signosVitales['saturacionOxigeno'] ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="temperatura">Temperatura</label>
                        <input type="number" class="form-control" name="temperatura" id="temperatura" value="<?= $signosVitales['temperatura'] ?>" required>
                    </div>
