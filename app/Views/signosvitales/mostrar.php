...
<head>
    ...
    <title>Lista de Signos Vitales</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Signos Vitales</h2>
                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th>Tensión Arterial (TA)</th>
                            <th>Saturación de Oxígeno (SpO2)</th>
                            <th>Temperatura</th>
                            <th>Acciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php foreach ($signosVitales as $signo) : ?>
                            <tr>
                            <td><?= ucfirst($signo['Paciente_ID']) ?></td>
                                
                                <td><?= ucfirst($signo['presionArterial']) ?></td>
                                <td><?= $signo['frecuenciaCardiaca'] ?></td>
                                <td><?= ucfirst($signo['tensionArterial']) ?></td>
                                <td><?= $signo['saturacionOxigeno'] ?></td>
                                <td><?= $signo['temperatura'] ?></td>
                                <td>
                                    <div class="container">
                                        <!-- Enlace para editar -->
                                        <a href="<?= base_url('signosvitales/editar/' . $signo['ID_SignosVitales']) ?>" class="btn btn-primary">Editar</a>

                                        <!-- Formulario para eliminar -->
                                        <form action="<?= base_url('signosvitales/delete/' . $signo['ID_SignosVitales']) ?>" method="POST" style="display:inline;">
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar estos signos vitales?')">Eliminar</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                             ...
                             <!-- Botón para agregar APHF -->
<div class="text-center mb-4">
    <a href="/aphf/agregar" class="btn btn-success">Agregar APHF</a>
</div>
        </div>
    </div>
