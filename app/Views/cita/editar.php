...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            <h2 class="form-title">Editar Cita</h2>
            <div class="row justify-content-center result-container">
                <table class="table">
                    ...
                    <tr>
                        <td><pre><?php print_r($cita); ?></pre></td>
                    </tr>
                </table>
            </div>
            <form action="<?= base_url('/cita/update'); ?>" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="numConsultorio" id="numConsultorio" value="<?= $cita['numConsultorio'] ?>" required>
                </div>

                <div class="form-group">
                    <label for="fisioterapeuta_ID">ID del Fisioterapeuta</label>
                    <input type="number" class="form-control" name="fisioterapeuta_ID" id="fisioterapeuta_ID" value="<?= $cita['fisioterapeuta_ID'] ?>" required>
                </div>

                <div class="form-group">
                    <label for="Paciente_ID">ID del Paciente</label>
                    <input type="number" class="form-control" name="Paciente_ID" id="Paciente_ID" value="<?= $cita['Paciente_ID'] ?>" required>
                </div>

                <div class="form-group">
                    <label for="Consultorio_ID">ID del Consultorio</label>
                    <input type="number" class="form-control" name="Consultorio_ID" id="Consultorio_ID" value="<?= $cita['Consultorio_ID'] ?>" required>
                </div>
