    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Agregar Cita</h2>
                <form action="<?= base_url('index.php/cita/insert'); ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="container">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="numConsultorio" class="form-label">Número de Consultorio</label>
                            <input type="number" class="form-control" name="numConsultorio" id="numConsultorio" required>
                        </div>

                        <div class="mb-3">
                            <label for="fisioterapeuta_ID" class="form-label">ID del Fisioterapeuta</label>
                            <input type="number" class="form-control" name="fisioterapeuta_ID" id="fisioterapeuta_ID" required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label for="Consultorio_ID" class="form-label">ID del Consultorio</label>
                            <input type="number" class="form-control" name="Consultorio_ID" id="Consultorio_ID" required>
                        </div>

                        <div class="mb-3">
                            <input type="submit" class="btn btn-success" value="Agregar Cita">
                        </div>
                    </div>
                </form>
            </div>
