...
<div class="container">
    <div class="row justify-content-center">
        ...
        <h2 class="form-title">Buscar Fisioterapeuta</h2>
            <form action="<?= base_url('index.php/fisioterapeuta/buscar/'); ?>" method="GET">
    ...
    <tr>
        ...
        <td>
            ...
            <a href="<?= base_url('fisioterapeuta/editar/' . $fisioterapeuta['ID_Fisioterapeuta']) ?>" class="btn btn-primary btn-sm">Editar</a>

            <!-- Formulario para eliminar con botón de Bootstrap -->
            <form action="<?= base_url('fisioterapeuta/eliminar/' . $fisioterapeuta['ID_Fisioterapeuta']) ?>" method="POST" style="display:inline;">
                <input type="hidden" name="_method" value="DELETE">
                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este fisioterapeuta?')">Eliminar</button>
            </form>
        </td>
    </tr>
<?php endforeach ?>
