...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            <h2 class="form-title">Agregar Fisioterapeuta</h2>
            <form action="<?= base_url('index.php/fisioterapeuta/insert'); ?>" method="POST">
                <?= csrf_field() ?>
                <div class="container">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="usuario" id="usuario" required pattern="[A-Za-z0-9]+" title="Ingresa solo letras y números, sin espacios.">
                </div>
    ...
    <input type="tel" class="form-control" name="telefono" id="telefono" required pattern="[0-9\s-]+" title="Ingresa solo números, espacios y guiones, sin caracteres especiales.">
</div>


                <div class="mb-3">
                    <input type="submit" class="btn btn-success" value="Agregar Fisioterapeuta">
                </div>
            </form>
        </div>
        <div class="col-3"></div>
