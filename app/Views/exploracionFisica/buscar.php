...
<head>
    ...
    <title>Buscar Exploración Física</title>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Buscar Exploración Física</h2>
                <form action="<?= base_url('index.php/exploracionfisica/buscar/'); ?>" method="GET">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <!-- Tabla de exploración física con clases de Bootstrap -->
                        ...
                        <?php foreach ($exploracionFisica as $exploracion) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('exploracionfisica/editar/' . $exploracion['ID_ExploracionFisica']) ?>" class="btn btn-primary btn-sm">Editar</a>

                                    <!-- Formulario para eliminar con botón de Bootstrap -->
                                    <form action="<?= base_url('exploracionfisica/eliminar/' . $exploracion['ID_ExploracionFisica']) ?>" method="POST" style="display:inline;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar esta exploración física?')">Eliminar</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach ?>
