        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 form-container">
                    <h2 class="form-title">Agregar Expediente</h2>
                    <form action="<?= base_url('index.php/expediente/insert'); ?>" method="POST">
                        <?= csrf_field() ?>
                        <div class="container">
                            
                        <div class="mb-3">
                                <label for="numExpediente" class="form-label">Número de Expediente</label>
                                <input type="number" class="form-control" name="numExpediente" id="numExpediente" required>
                            </div>
                            ...
                            <div class="mb-3">
                                <input type="submit" class="btn btn-success" value="Agregar Expediente">
                            </div>
                        </div>
                    </form>
                </div>
