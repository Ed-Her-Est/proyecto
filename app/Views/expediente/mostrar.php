...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <h2 class="text-center mb-4">Expedientes</h2>
                ...
                <table class="table table-bordered table-striped text-center">
                    ...
                    <tbody>
                        ...
                        <?php if (isset($expedientes) && is_array($expedientes)) : ?>
                        <?php foreach ($expedientes as $expediente) : ?>
                            <tr>
                                <td><?= ucfirst($expediente['numExpediente']) ?></td>
                                ...
                                <td>
                                    <div class="container">
                                        <!-- Enlace para editar -->
                                        <a href="<?= base_url('expediente/editar/' . $expediente['ID_Expediente']) ?>" class="btn btn-primary">Editar</a>

                                        <!-- Formulario para eliminar -->
                                        <form action="<?= base_url('expediente/delete/' . $expediente['ID_Expediente']) ?>" method="POST" style="display:inline;">
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar estos datos del Expediente?')">Eliminar</button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
...
<div class="text-center mb-4">
    <a href="/cita/agregar" class="btn btn-success">Agregar Cita</a>
</div>
        </div>
        </div>
    </div>
