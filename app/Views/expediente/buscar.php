...
<head>
    ...
    <title>Formulario de Expediente</title>
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <h2 class="form-title">Buscar Expediente</h2>
            <form action="<?= base_url('index.php/expediente/buscar/'); ?>" method="GET">
                <label for="numExpediente">Número de Expediente</label>
                <input type="text" class="form-control" name="numExpediente">
                <label for="fechaIngreso">Fecha de Ingreso</label>
                <input type="text" class="form-control" name="fechaIngreso">
                <label for="Paciente_ID">ID del Paciente</label>
                <input type="text" class="form-control" name="Paciente_ID">
                <label for="Consultorio_ID">ID del Consultorio</label>
                <input type="text" class="form-control" name="Consultorio_ID">
    ...
    <div class="col-md-8">
        ...
        <!-- Tabla de expedientes con clases de Bootstrap -->
    ...
    <tr>
        ...
        <td><?= $expediente['Paciente_ID'] ?></td>
        <td><?= $expediente['Consultorio_ID'] ?></td>
        <td>
            <!-- Enlace para editar con botón de Bootstrap -->
            <a href="<?= base_url('expediente/editar/' . $expediente['ID_Expediente']) ?>" class="btn btn-primary btn-sm">Editar</a>

            <!-- Formulario para eliminar con botón de Bootstrap -->
            <form action="<?= base_url('expediente/eliminar/' . $expediente['ID_Expediente']) ?>" method="POST" style="display:inline;">
                <input type="hidden" name="_method" value="DELETE">
                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este expediente?')">Eliminar</button>
            </form>
        </td>
    </tr>
<?php endforeach ?>
