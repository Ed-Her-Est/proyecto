    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Agregar APHF</h2>
                <form action="<?= base_url('index.php/aphf/insert'); ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="container">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="hta" name="hta">
                            <label class="form-check-label" for="hta">HTA</label>
                        </div>

                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="cardiopatia" name="cardiopatia">
                            <label class="form-check-label" for="cardiopatia">Cardiopatía</label>
                        </div>

                        <div class="form-group form-check">
                            <input type="checkbox" class="form-check-input" id="enfermedadesReumaticas" name="enfermedadesReumaticas">
                            <label class="form-check-label" for="enfermedadesReumaticas">Enfermedades Reumáticas</label>
                        </div>

                        <div class="mb-3">
                            <input type="submit" class="btn btn-success" value="Agregar APHF">
                        </div>
                    </form>
                </div>
                <div class="col-3"></div>
