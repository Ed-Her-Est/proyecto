...
<head>
    ...
    <title>Formulario de APHF</title>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 form-container">
            <h2 class="form-title">Buscar APHF</h2>
            <form action="<?= base_url('index.php/aphf/buscar/'); ?>" method="GET">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <!-- Tabla de fisioterapeutas con clases de Bootstrap -->
            <table class="table table-bordered table-striped text-center">
                ...
                <tbody>
                    <?php foreach ($aphf as $aphfs) : ?>
                        <tr>
                            <td><?= $aphfs['Paciente_ID'] ?></td>
                       
                            <td>
                                <!-- Enlace para editar con botón de Bootstrap -->
                                <a href="<?= base_url('aphf/editar/' . $aphfs['ID_APHF']) ?>" class="btn btn-primary btn-sm">Editar</a>

                                <!-- Formulario para eliminar con botón de Bootstrap -->
                                <form action="<?= base_url('aphf/eliminar/' . $aphfs['ID_APHF']) ?>" method="POST" style="display:inline;">
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar este APHF?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach ?>
