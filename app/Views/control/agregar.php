    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Agregar Control</h2>
                <form action="<?= base_url('index.php/control/insert'); ?>" method="POST">
                    <?= csrf_field() ?>
                    <div class="container">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="telefono" id="telefono" required pattern="[0-9\s-]+" title="Ingresa solo números, espacios y guiones, sin caracteres especiales.">
                        </div>
                        ...
                        <div class="mb-3">
                            <input type="submit" class="btn btn-success" value="Agregar Control">
                        </div>
                    </div>
                </form>
            </div>
