    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 form-container">
                <h2 class="form-title">Buscar Datos Generales</h2>
                <form action="<?= base_url('index.php/datosgenerales/buscar/'); ?>" method="GET">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <!-- Tabla de datos generales con clases de Bootstrap -->
                        ...
                        <?php foreach ($datosGenerales as $dato) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= base_url('datosgenerales/editar/' . $dato['ID_DatosGenerales']) ?>" class="btn btn-primary btn-sm">Editar</a>

                                    <!-- Formulario para eliminar con botón de Bootstrap -->
                                    <form action="<?= base_url('datosgenerales/eliminar/' . $dato['ID_DatosGenerales']) ?>" method="POST" style="display:inline;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de que deseas eliminar estos datos generales?')">Eliminar</button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach ?>
