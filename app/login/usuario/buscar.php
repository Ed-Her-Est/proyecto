...
<div class="container">
    ...
    <div class="col-md-8">
        ...
        <!-- Tabla de usuarios con clases de Bootstrap -->
                ...
                <?php foreach ($usuarios as $usuario) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('usuario/editar/' . $usuario->ID_Usuario) ?>" class="btn btn-primary btn-sm">Editar</a>
                            
                            <!-- Formulario para eliminar con botón de Bootstrap -->
                            <form action="<?= base_url('usuario/eliminar/' . $usuario->ID_Usuario) ?>" method="POST" style="display:inline;">
